...
class WebPageLead
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('webpages_leads')
            ->setCustomRepositoryClass('Mautic\LeadBundle\Entity\WebPageLeadRepository');

        $builder->createManyToOne('webpage', 'WebPage')
            ->isPrimaryKey()
            ->inversedBy('leads')
            ->addJoinColumn('webpage_id', 'id', false, false, 'CASCADE')
            ->build();
