...
class UserRepository extends CommonRepository
{
    ...
    protected function addSearchCommandWhereClause(&$q, $filter)
    {
        ...
        switch ($command) 
        {
            ...
            case $this->translator->trans('mautic.user.user.searchcommand.businessgroup'):
                $expr = $q->expr()->like('b.name', ':'.$unique);
                break;
    ...
    public function getSearchCommands()
    {
        return [
            ...
            'mautic.user.user.searchcommand.businessgroup',
