...
class User extends FormEntity implements AdvancedUserInterface, \Serializable
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->createManyToOne('businessgroup', 'BusinessGroup')
            ->inversedBy('users')
            ->addJoinColumn('businessgroup_id', 'id', false)
            ->build();
            
        $builder->createField('isOwner', 'boolean')
            ->columnName('is_owner')
            ->build();
    ...
    {
        $this->isChanged('isOwner', $isOwner);
     ...
     * @return User
     */
    public function setBusinessGroup(BusinessGroup $businessgroup = null)
    {
