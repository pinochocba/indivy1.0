    ...
    <table class="table table-hover table-striped table-bordered user-list" id="userTable">
        ...
        <?php foreach ($items as $item):?>
            <tr>
                ...
                <td <?php if($item->getRole()->getId() == 1): print "style='background-color:red'"; endif;?>> <?php echo $item->getUsername(); ?></td>
                <td class="visible-md visible-lg">
                    <a href="mailto: <?php echo $item->getEmail(); ?>"><?php echo $item->getEmail(); ?></a>
                </td>
                <td class="visible-md visible-lg"><?php echo $item->getRole()->getName(); ?> <b> <?php echo $item->getBusinessGroup()->getName(); ?> </td>
