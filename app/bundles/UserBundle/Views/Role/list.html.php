...
<div class="table-responsive">
    <table class="table table-hover table-striped table-bordered role-list" id="roleTable">
        ...
        <?php foreach ($items as $item): ?>
            <tr <?php if($item->getId() == 1): print "style='background-color:red'"; endif; ?>>
                <td>
                    <?php
                ...
                <td>
                    ...
                    <a href="<?php echo $view['router']->path('mautic_role_action', ['objectAction' => 'edit', 'objectId' => $item->getId()]); ?>" data-toggle="ajax">
                ...
                <td class="visible-md visible-lg">
                    <a class="label label-primary" href="<?php echo $view['router']->path('mautic_user_index', ['search' => $view['translator']->trans('mautic.user.user.searchcommand.role').':&quot;'.$item->getName().'&quot;']); ?>" data-toggle="ajax"<?php echo ($userCounts[$item->getId()] == 0) ? 'disabled=disabled' : ''; ?>>
